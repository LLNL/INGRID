import sys
sys.path.append('/Users/umansky1/Projects/INGRID/INGRID_snl_refined/src')
...
i=Ingrid()
#i.yaml['eqdsk']='/Users/umansky1/Projects/INGRID/INGRID_snl_refined/data/SNL/DIII-D/neqdsk'
i.yaml['eqdsk']='/Users/umansky1/Projects/INGRID/INGRID_snl_refined/data/SF15/neqdsk'
i.OMFIT_read_psi()
i.psi_norm=0
i.eq=0
i.plate_data=0
...
tag='v'
grid0=i.efit_psi
grid0.Calculate_PDeriv(unit_spacing=True)
##grid0.Calculate_PDeriv(unit_spacing=False) ##-this would produce garbage, must use unit_spacing=True!
