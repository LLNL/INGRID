...
class SF45(Topology):
    ...
    def construct_patches(self):
        ...
        # B1_N / B2_S
        xpt1NW__west_midLine = self.LineTracer.draw_line(xpt1['NW'], {'line': west_midLine}, option='theta', direction='cw', show_plot=visual, text=verbose)
        B1_N = xpt1NW__west_midLine
        B2_S = B1_N.reverse_copy()

        # H2_S / H1_N
        xpt1NE__east_midLine = self.LineTracer.draw_line(xpt1['NE'], {'line': east_midLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        E1_N = xpt1NE__east_midLine.reverse_copy()
        E2_S = E1_N.reverse_copy()

        # C1_N / C2_S
        west_midLine__topLine = self.LineTracer.draw_line(xpt1NW__west_midLine.p[-1], {'line': topLine}, option='theta', direction='cw', show_plot=visual, text=verbose)
        C1_N = west_midLine__topLine
        C2_S = C1_N.reverse_copy()

        # D1_N / D2_S
        east_midLine__topLine = self.LineTracer.draw_line(xpt1NE__east_midLine.p[-1], {'line': topLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        ...
        # / B1_S
        psiMinCore__west_midLine_core = self.LineTracer.draw_line(xpt1N__psiMinCore.p[-1], {'line': west_midLine}, option='theta', direction='cw', show_plot=visual, text=verbose)
        B1_S = psiMinCore__west_midLine_core.reverse_copy()

        # H1_E1
        psiMinCore__east_midLine_core = self.LineTracer.draw_line(xpt1N__psiMinCore.p[-1], {'line': east_midLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        E1_S = psiMinCore__east_midLine_core

        # / C1_S
        west_midLine_core__topLine = self.LineTracer.draw_line(psiMinCore__west_midLine_core.p[-1], {'line': topLine}, option='theta', direction='cw', show_plot=visual, text=verbose)
        C1_S = west_midLine_core__topLine.reverse_copy()

        # D1_S
        east_midLine_core__topLine = self.LineTracer.draw_line(psiMinCore__east_midLine_core.p[-1], {'line': topLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        ...
        # E3_S / E2_N
        xpt2NE__east_midLine = self.LineTracer.draw_line(xpt2['NE'], {'line': east_midLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        F2_W = self.LineTracer.draw_line(xpt1['E'], {'line': xpt2NE__east_midLine}, option='rho', direction='ccw', show_plot=visual, text=verbose)
        ...
        # D3_S / D2_N
        xpt2__east_midLine__topLine = self.LineTracer.draw_line(xpt2NE__east_midLine.p[-1], {'line': topLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        D3_S = xpt2__east_midLine__topLine
        D2_N = D3_S.reverse_copy()

        # C3_S / C2_N
        xpt2__topLine__west_midLine = self.LineTracer.draw_line(xpt2__east_midLine__topLine.p[-1], {'line': west_midLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        C3_S = xpt2__topLine__west_midLine
        C2_N = C3_S.reverse_copy()

        xpt2__west_midLine__WestPlate1 = self.LineTracer.draw_line(xpt2__topLine__west_midLine.p[-1], {'line': WestPlate1}, option='theta', direction='ccw', show_plot=visual, text=verbose)

        B2_W = self.LineTracer.draw_line(xpt1['W'], {'line': xpt2__west_midLine__WestPlate1}, option='rho', direction='ccw', show_plot=visual, text=verbose)
        ...
        H3_E = self.LineTracer.draw_line(xpt2['W'], {'psi': psi_max_east}, option='rho', direction='ccw', show_plot=visual, text=verbose).reverse_copy()
        ...
        G3_W = self.LineTracer.draw_line(xpt2['E'], {'psi': psi_max_west}, option='rho', direction='ccw', show_plot=visual, text=verbose)
        ...
        G3_W__east_midLine = self.LineTracer.draw_line(G3_W.p[-1], {'line': east_midLine}, option='theta', direction='ccw', show_plot=visual, text=verbose)

        F3_W = self.LineTracer.draw_line(F2_W.p[-1], {'line': G3_W__east_midLine}, option='rho', direction='ccw', show_plot=visual, text=verbose)
        ...
        C3_N = self.LineTracer.draw_line(D3_N.p[0], {'line': west_midLine}, option='theta', direction='ccw', show_plot=visual, text=verbose).reverse_copy()

        west_midLine__WestPlate1 = self.LineTracer.draw_line(C3_N.p[0], {'line': WestPlate1}, option='theta', direction='ccw', show_plot=visual, text=verbose)
        B3_W = self.LineTracer.draw_line(B2_W.p[-1], {'line': west_midLine__WestPlate1}, option='rho', direction='ccw', show_plot=visual, text=verbose)
