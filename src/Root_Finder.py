...
class RootFinder:
    ...
    grid : EfitData.EfitData
        Uses the grid definitions defined in the EfitData class
        to find the roots.
    ...
    def find_root(self, x, y, topofeature='default'):
        ...
        """
        # plt.cla()
        # self.controller.IngridSession.PlotEFIT()
        # self.controller.IngridSession.PlotTargetPlates()
...
#    from interpol.EfitData import EfitData
