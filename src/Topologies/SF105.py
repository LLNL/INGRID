...
class SF105(TopologyUtils):
    ...
    def construct_patches(self):
        ...
        C1_E = self.eq.draw_line(C1_N.p[-1], {'psi_horizontal' : psi_core}, option='z_const', direction='cw',
            show_plot=visual, text=verbose)
        ...
        E1_E = self.eq.draw_line(E1_N.p[-1], {'psi_horizontal' : psi_core}, option='z_const', direction='ccw',
            show_plot=visual, text=verbose)
        ...
        D1_E = self.eq.draw_line(D1_N.p[-1], {'psi_vertical' : psi_core}, option = 'r_const', direction = 'ccw', 
            show_plot = visual, text = verbose)
